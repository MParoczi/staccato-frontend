...
```bash
INIT=$(node "C:/Users/shift/Desktop/gsd-test/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/shift/Desktop/gsd-test/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
