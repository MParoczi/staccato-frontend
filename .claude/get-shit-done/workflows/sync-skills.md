...
INSTALL_JS_GLOBAL="C:/Users/shift/Desktop/gsd-test/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/shift/Desktop/gsd-test/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
