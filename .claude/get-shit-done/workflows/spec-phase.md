...
```bash
INIT=$(node "C:/Users/shift/Desktop/gsd-test/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/shift/Desktop/gsd-test/.claude/get-shit-done/templates/spec.md.
