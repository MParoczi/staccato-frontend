...
```
Agent(
  prompt="Read C:/Users/shift/Desktop/gsd-test/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/shift/Desktop/gsd-test/.claude/get-shit-done/templates/SECURITY.md`
